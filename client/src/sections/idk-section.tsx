...
export default function IdkSection() {
    ...
    return (<>
            <section
        ref={container}
            className="px-64 py-52 relative overflow-hidden h-screen">
        <div className="flex flex-col justify-between items-start gap-48 h-full">
            ...
            <div className="text-neutral-700 font-extralight mt-auto text-8xl text-center">
                Beauty in minimalism, where every element serves a purpose.
            </div>
        </div>
        </section>
